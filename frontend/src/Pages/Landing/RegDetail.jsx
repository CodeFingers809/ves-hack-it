      ...
      <div className="relative max-w-6xl mx-auto py-6 px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex-1 space-y-4 flex flex-col items-center">
            <h2 className="text-orange-400/90 font-semibold tracking-wide text-xs uppercase mb-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full">
              ...
              <div className="flex items-center justify-center gap-2 group">
                ...
                <div>
                  <p className="text-green-400 font-medium text-sm">Software Track</p>
              ...
              <div className="flex items-center justify-center gap-2">
                ...
                <div>
                  <p className="text-orange-400 font-medium text-sm">Hardware Team</p>
              ...
              <div className="flex items-center justify-center gap-2">
                ...
                <div>
                  <p className="text-blue-400 font-medium text-sm">Individual (Hardware)</p>
            ...
            {/* Venue Section */}
            <div
              onClick={() => window.open("https://maps.app.goo.gl/NPvAH6Nxqpmk9JxLA", "_blank")}
            ...
            >
              ...
              <span className="text-xs text-slate-200">
                Vesit, Hashu Adwani Memorial Complex, Collector's Colony, Chembur, Mumbai, Maharashtra 400074
              </span>
            </div>
          </div>
        </div>
